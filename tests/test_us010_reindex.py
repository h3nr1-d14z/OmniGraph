...
gate itself is run in docs/runbooks/reindex.md "Acceptance gate" section.
"""
...
def test_runbook_documents_5step_quiesce_protocol():
    doc = (REPO / "docs" / "runbooks" / "reindex.md").read_text()
    ...
    for marker in (
        ...
        assert marker in doc, f"docs/runbooks/reindex.md missing protocol marker: {marker!r}"
